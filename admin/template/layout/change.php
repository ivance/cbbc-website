<div class="container-fluid">
	...
	<div class="content">
		...
		<fieldset>
			...
			<div class="clearfix">
            	<label for="user_name">新用户名:</label>
            	<div class="input"><input type="text" size="30" name="new_user_name" id="user_name" class="xlarge"></div>
			</div>

			<div class="clearfix">
            	<label for="password">新密码:</label>
            	<div class="input"><input type="text" size="30" name="new_password" id="password" class="xlarge"></div>
			</div>

			<div class="input"><input type="submit" value="提交" class="btn primary"></div>
